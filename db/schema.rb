...
ActiveRecord::Schema[7.0].define(version: 2024_06_25_212715) do
  ...
  create_table "app_informations", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "fullname"
    t.string "position"
  ...
  create_table "auth_tokens", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["admin_id"], name: "index_auth_tokens_on_admin_id"
  end

  create_table "cms", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "core_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "auth_tokens", "admins"
end
